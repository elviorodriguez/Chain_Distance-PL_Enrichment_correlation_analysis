...
1. Predict or obtain protein complex structures (e.g., from AlphaFold-based pipelines).
2. Run the analyzer on a directory of structure files.
3. Obtain a table of pairwise distances and summary statistics.
4. Integrate with experimental data (e.g., proximity labeling, proteomics).
5. Assess whether structural proximity correlates with enrichment or interaction strength.
